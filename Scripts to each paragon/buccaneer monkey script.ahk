...
StartDeflation(){
    ...
    MouseClick, left, 530, 260  ; Spice Island map
    Sleep, 1750
...
Monkey(){
    ...
    PlaceMonkey("v", 350, 650, 4, 0, 2)
    PlaceMonkey("d", 650, 415, 0, 3, 2)
    PlaceMonkey("e", 960, 390, 0, 3, 2)
    PlaceMonkey("e", 1215, 450, 0, 3, 2)
    MouseClick, left, 1100, 540
    Sleep, 500
    MouseClick, left, 960, 620
    Sleep, 500
