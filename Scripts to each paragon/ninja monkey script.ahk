...
StartDeflation(){
    ...
    Sleep, 1750
    ; Depended on which map you use, remeber to put a goright or goleft function and then the coordinates to the map with a click
...
PlaceMonkey(mokney_type, x, y, one, two, three){
    MouseMove, x, y
    SelectMonkey(mokney_type)
    Sleep, 500
    MouseClick, left, x, y
    Sleep, 500
    UpgradeMonkey(x, y, one, two, three)
...
Monkey(){
    ...
    PlaceMonkey("L", 625, 555, 4, 0, 2)
    PlaceMonkey("L", 625, 495, 2, 0, 4)
    PlaceMonkey("L", 625, 400, 4, 0, 2)
    PlaceMonkey("L", 700, 400, 3, 0, 2)
    PlaceMonkey("L", 695, 495, 2, 0, 1)
