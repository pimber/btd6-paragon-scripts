...
Monkey(){
    ...
    PlaceMonkey("Q", 625, 500, 4, 0, 2)
    PlaceMonkey("Q", 625, 570, 0, 2, 4)

    PlaceMonkey("Q", 700, 400, 0, 2, 4)
    PlaceMonkey("Q", 700, 500, 0, 2, 4)

    PlaceMonkey("Q", 775, 500, 0, 1, 2)

    PlaceMonkey("Q", 890, 460, 4, 0, 2)
    PlaceMonkey("Q", 960, 460, 2, 0, 4)
